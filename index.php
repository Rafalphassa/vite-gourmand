    ...
    <div class="container py-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 mt-5 mt-lg-0">
                ...
                ">
                    <h3 style="font-family:'Playfair Display',serif; color:#D4A853; margin-bottom:20px;">
                        Notre équipe
                    </h3>
    ...
    <div class="container py-4">
        ...
        <div class="row g-4">
            ...
            $atouts = [
                ...
                ['Équipe dévouée',    'Julie et José mettent 25 ans de savoir-faire à votre service.'],
            ...
            <div class="col-md-6 col-lg-3">
                <div style="
                    ...
                    padding:30px 25px; text-align:center; height:100%;
                ">
                    <h5 style="font-family:'Playfair Display',serif; color:#1A5F7A;">
                        <?php echo htmlspecialchars($a[0]); ?>
                    </h5>
...
<section class="py-5" style="background:#F0EDE4;">
    <div class="container py-4">
        ...
        <?php if(empty($avis)): ?>
            <p class="text-center" style="color:#999;">Aucun avis pour le moment.</p>
        <?php else: ?>
        <div class="row g-4">
