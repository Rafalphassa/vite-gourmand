        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                ...
                <div class="d-flex justify-content-between small">
                    ...
                    <?php if($h['ferme']): ?>
                        <span style="color:#D4A853;">Fermé</span>
                    <?php else: ?>
                        <span><?php echo $h['heure_ouverture'].' - '.$h['heure_fermeture']; ?></span>
                    <?php endif; ?>
                </div>
                <?php endforeach; ?>
            </div>
            ...
            <div class="col-md-4">
                ...
                <ul class="list-unstyled small">
                    <li><a href="/vite-gourmand/mentions-legales.php" style="color:#F0EDE4;">Mentions légales</a></li>
